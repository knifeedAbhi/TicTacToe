...
plus = '+'
second_move = False
dict1 = {       #here we can store the positions of both 'X' and 'O'
    1: '-',
    2: '-',
    3: '-',
    4: '-',
...
dict_ref = {    #this dict is for the reference of the user, to avoid confusion
    1: '1',
    2: '2',
    3: '3',
    4: '4',
...
def reference():    #prints dummy tic-tac-toe
    itera_odd = True
    x = 9
...
occupied = 0    #number of places occupied.
...
def game(second_move,occupied):
    ...
    if occupied<9:
        ...
        if second_move == False:
            ...
            if dict1[1] == dict1[4] == dict1[7] != '-' or dict1[1] == dict1[5] == dict1[9] != '-' or dict1[1] == dict1[2] == dict1[3] != '-' or dict1[4] == dict1[5] == dict1[6] != '-' or dict1[7] == dict1[8] == dict1[9] != '-' or dict1[3] == dict1[5] == dict1[7] != '-' or dict1[2] == dict1[5] == dict1[8] != '-' or dict1[3] == dict1[6] == dict1[9] != '-':
                print('\nGame Over.\n')
                print(f'\n*****{curr_move} has won*****\n')
                show_game()
...
def show_game():    #displays current positions
    itera_odd = True
    x = 9
    for col in range(1, 6):
        if itera_odd == True:
